trigger LeadBusinessHours on Lead(after insert, after update, before insert, before update ){
    ...
    public void updateSLAFields(List<Lead> newLeadList, List<Lead> oldLeadList){
        ...
        BusinessHours stdBusinessHours = [select id
                                          from businesshours
                                          where isDefault = true];
        List<Sla_Manager__mdt> AssignSLA = [select label, Start_Value__c, SLA__c
            ...
            if (trigger.isinsert){
                if (newLeadList.size() > 0){
                    for (Lead l : newLeadList){
                        ...
                        if (status == 'New'){
                            if ((l.LeadSource == 'Branch Call' || l.LeadSource == 'Branch Walk in' || l.LeadSource == 'Call Center' || l.LeadSource == 'Email' || l.LeadSource == 'Employee Referral' || l.LeadSource == 'Xpress Form - Web' || l.LeadSource == 'Partner' || l.LeadSource == 'PTM' || l.LeadSource == 'Xpress Refi-Web' || l.LeadSource == 'Xpress Refi' || l.LeadSource == 'Existing Member') && l.Product_Type__c == 'Mortgage'){
            ...
            if (trigger.isUpdate){
                ...
                if (newLeadList.size() > 0){
                    for (Lead l : newLeadList){
                        ...
                        List<string> NewLeadSources = new List<String>{'Branch Call', 'Branch Walk in', 'Call Center' , 'Email', 'Employee Referral' , 'Xpress Form - Web', 'Partner', 'PTM', 'Xpress Refi-Web', 'Xpress Refi', 'Existing Member'};
                        ...
                        if (status == 'New' && oldStatus != 'New'){
                            ...
                            if (l.LeadSource == 'Branch Call' || l.LeadSource == 'Branch Walk in' || l.LeadSource == 'Call Center' || l.LeadSource == 'Email' || l.LeadSource == 'Employee Referral' || l.LeadSource == 'Xpress Form - Web' || l.LeadSource == 'Partner' || l.LeadSource == 'PTM' || l.LeadSource == 'Xpress Refi-Web' || l.LeadSource == 'Xpress Refi' || l.LeadSource == 'Existing Member'){
                                if (AssignSLA.size() > 0 && SLA != null){
                                    l.SLA__c = SLA;
                                } else{
                                    l.SLA__c = null;
                        ...
                        else if(NewLeadSources.contains(newLeadSource) && !NewLeadSources.contains(oldLeadSource) && status == 'New' && newProductType == 'Mortgage'){
                            if (AssignSLA.size() > 0 && SLA != null){
                                l.SLA__c = SLA;
                            } else{
                                l.SLA__c = null;
                        ...
                        /*if ((status == 'New' && oldStatus != 'New')||(status == 'Outreach' && oldStatus != 'Outreach') ){
                            if ((status == 'New' && oldStatus != 'New')||(status == 'Outreach' && oldStatus != 'Outreach') && (l.LeadSource == 'Branch Call' || l.LeadSource == 'Branch Walk in' || l.LeadSource == 'Call Center' || l.LeadSource == 'Email' || l.LeadSource == 'Employee Referral' || l.LeadSource == 'Xpress Form - Web' || l.LeadSource == 'Partner' || l.LeadSource == 'PTM' || l.LeadSource == 'Xpress Refi-Web' || l.LeadSource == 'Xpress Refi' || l.LeadSource == 'Existing Member')
                             && l.Product_Type__c == 'Mortgage'){
                                if (AssignSLA.size() > 0  && SLA != null){
                                    l.SLA__c = SLA;
                                    system.debug('updation-SLA'+ l.SLA__c);
                                } else{
                                    l.SLA__c =null;
                                }
                            } else{
                       ...
                       //if(l.Product_Type__c != 'Mortgage' && ( l.LeadSource != 'Branch Call' || l.LeadSource != 'Branch Walk in' || l.LeadSource != 'Call Center' || l.LeadSource != 'Email' || l.LeadSource != 'Employee Referral' || l.LeadSource != 'Xpress Form - Web' || l.LeadSource != 'Partner' || l.LeadSource != 'PTM' || l.LeadSource != 'Xpress Refi-Web' || l.LeadSource != 'Xpress Refi' || l.LeadSource != 'Existing Member')){
                        //l.SLA__c=NULL;
                      // }
                        ...
                        /*----------Update Breach Flag--------*/
                        // if(l.isSLABreached__c == true && oldlead.isSLABreached__c == false){
                        //     l.SLABreached__c = true;
                        // }
