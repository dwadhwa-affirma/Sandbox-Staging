({
    ...
    getRecordData:function(component, event, helper) {
        ...
        action.setCallback(this,function(res){
            ...
            if(state==="SUCCESS"){
                component.set("v.ACLogDetails",response);
            }
        });       
    ...
    saveHelper:function(component, event, helper){         
        ...
        action.setCallback(this,function(res){
            ...
            if(state==="SUCCESS"){
               ...
               {
                var url = '/apex/ESignatureAC?id=' + recordId;
	...
	getIdentificationMethodPickListValues:function(component, event, helper) {      
        var action = component.get("c.getIdentificationMethodPickListValues");        
        action.setCallback(this,function(res){
            var state = res.getState();
            var response=res.getReturnValue();
            if(state==="SUCCESS"){
                component.set("v.IdentificationMethodsList",response);
            }
        });       
        $A.enqueueAction(action);
    },
	getIntakeMethodPickListValues:function(component, event, helper) {      
        var action = component.get("c.getIntakeMethodPickListValues");        
        action.setCallback(this,function(res){
            var state = res.getState();
            var response=res.getReturnValue();
            if(state==="SUCCESS"){
                component.set("v.IntakeMethodsList",response);
            }
        });       
        $A.enqueueAction(action);
    },
