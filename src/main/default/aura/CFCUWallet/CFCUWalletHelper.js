    ...
    GetJointMemberDetail: function (component, event,helper, memberId, IVRGUIDFromUrl) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (component.isValid() && status === "SUCCESS") {
                ...
                if(result.onlineUserName.length > 0 && result.onlineUserName[0].Digital_Banking_Username_Chevron__c !== undefined ){
                    component.set("v.OnlineUserName", result.onlineUserName[0].Digital_Banking_Username_Chevron__c);
                    component.set("v.IsOnlineUserNameAvailable", true);
                }
                else
                {
                    component.set("v.IsOnlineUserNameAvailable", false);
                }
                ...
                if(result.CFCULastSessionInfo != undefined && result.CFCULastSessionInfo.length > 0 && result.CFCULastSessionInfo[0].CFCU_Wallet_Status__c != undefined && component.get("v.IsUserSessionLoaded") == true){
                    ...
                    if(result.CFCULastSessionInfo[0].Online_User_Name_Match__c == undefined){
                        component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                        component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                    }
                    if(result.CFCULastSessionInfo[0].Online_User_Name_Match__c == 'Pass'){
                        component.find('onlineUserNamePassButton').set("v.variant", "success");
                        component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                    }
                    if(result.CFCULastSessionInfo[0].Online_User_Name_Match__c == 'Fail'){
                        component.find('onlineUserNameFailButton').set("v.variant", "destructive");
                        component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                    }
                    ...
                    if(result.CFCULastSessionInfo[0].CFCU_Wallet_Status__c == 'Pass'){
                        ...
                        if(result.CFCUReloadInfo != undefined && result.CFCUReloadInfo.length > 0 && component.get("v.IsReLoadRequired") == true){
                            ...
                            if(result.CFCUReloadInfo[0].Online_User_Name_Match__c == undefined){
                                component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                                component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                            }
                            if(result.CFCUReloadInfo[0].Online_User_Name_Match__c == 'Pass'){
                                component.find('onlineUserNamePassButton').set("v.variant", "success");
                                component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                            }
                            if(result.CFCUReloadInfo[0].Online_User_Name_Match__c == 'Fail'){
                                component.find('onlineUserNameFailButton').set("v.variant", "destructive");
                                component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                            }
                            ...
                            if(result.CFCUReloadManulSessionInfo[0].Online_User_Name_Match__c == undefined){
                                component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                                component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                            }
                            if(result.CFCUReloadManulSessionInfo[0].Online_User_Name_Match__c == 'Pass'){
                                component.find('onlineUserNamePassButton').set("v.variant", "success");
                                component.find('onlineUserNameFailButton').set("v.variant", "neutral");
                            }
                            if(result.CFCUReloadManulSessionInfo[0].Online_User_Name_Match__c == 'Fail'){
                                component.find('onlineUserNameFailButton').set("v.variant", "destructive");
                                component.find('onlineUserNamePassButton').set("v.variant", "neutral");
                            }
    ...
    ButtonPassFailMethod : function(component, event, helper,ButtonId,Button) {
        ...
        {	
            ...
            findOtherButton = component.find('BeneficiaryFailButton');
                    ...
                    if(ButtonId =='BeneficiaryPassButton'){
                    ...
                    else if(ButtonId =='onlineUserNamePassButton'){
                        findOtherButton = component.find('onlineUserNameFailButton');
                        if(Button.get("v.variant") ==  "success"){
                            QuestionAttempt = parseInt(QuestionAttempt) - 1;
                            Button.set("v.variant", "neutral");
                            ScoreObtained = parseInt(ScoreObtained) - 1;
                        ...
                        component.set("v.ScoreObtained",ScoreObtained);
                        findOtherButton.set("v.variant", "neutral");                            
                        component.set("v.OnlineUserNameMatch",onlineUserNameMatch);
                        if(QuestionAttempt >=3 && IsCFCUFailForTheDay != 'Fail' && IsCFCUFailOnReload != 'Fail'){
                            component.set("v.IsButtonDisabled",false);
                        }
                    }
                    else if(ButtonId =='onlineUserNameFailButton'){                       
                        findOtherButton = component.find('onlineUserNamePassButton');
                        if(Button.get("v.variant") ==  "destructive"){
                            QuestionAttempt = parseInt(QuestionAttempt) - 1;
                            FailedCount = parseInt(FailedCount) - 1;
                            Button.set("v.variant", "neutral");
                ...
                else if(ButtonId == 'SubmitButton')
                {
                    ...
                    if(component.get("v.QuestionAttempt") <=2){
                        ...
                        var onlineUserName = component.get("v.OnlineUserName");
                        onlineUserNameMatch = component.get("v.OnlineUserNameMatch");
                        
                        if(onlineUserNameMatch === undefined || onlineUserNameMatch == '')
                        {
                            onlineUserName = '';
                        }
                        ...
                        action.setParams({"MemberId": memberId,
                                            ...
                                            "onlineUserNameMatch":onlineUserNameMatch,
                        ...
                        action.setCallback(this, function (response) {	    
                            ...
                            if (component.isValid() && status === "SUCCESS") {
                                var result = response.getReturnValue();
                                console.log('CFCU log save result' + result);
                            }
                            else
                            {
